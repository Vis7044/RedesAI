...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-white py-8 fixed left-0 right-0 bottom-0">
    <div className="container mx-auto px-4">
      <div className="flex flex-wrap justify-between">
        <div className="w-full md:w-1/3 mb-6 md:mb-0">
          <h3 className="text-2xl font-bold mb-4">RedisAI</h3>
          <p className="text-gray-400">Empowering businesses with social media intelligence.</p>
        </div>
        <div className="w-full md:w-1/3 mb-6 md:mb-0">
