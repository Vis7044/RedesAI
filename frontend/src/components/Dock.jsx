  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={`${className} fixed sm:absolute bottom-2 right-1/2 left-1/2 sm:top-12  transform -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-2 pb-2 px-4`}
